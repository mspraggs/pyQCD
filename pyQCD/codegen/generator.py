...
def make_template_args(syntax_tree):
    ...
    template_args.update(apply_herm_body=generator.funcgen("apply_hermitian"))
    template_args.update(make_herm_body=generator.funcgen("make_hermitian"))
    template_args.update(apply_even_even_inv_body
                         =generator.funcgen("apply_even_even_inv"))
    template_args.update(apply_odd_odd_body=generator.funcgen("apply_odd_odd"))
    template_args.update(apply_even_odd_body
                         =generator.funcgen("apply_even_odd"))
    template_args.update(apply_odd_even_body
                         =generator.funcgen("apply_odd_even"))
