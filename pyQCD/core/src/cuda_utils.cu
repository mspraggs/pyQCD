...
namespace pyQCD
{
  ...
  {  
		      ...
		      tempSource)
    {
      ...
      cusp::blas::fill(tempSource, cusp::complex<double>(0.0, 0.0));
      tempSource[index] = cusp::complex<double>(1.0, 0.0);
	...
	std::cout << " Done!" << std::endl;
      ...
      cusp::array1d<cusp::complex<double>, devMem>
	source(nCols, cusp::complex<double>(0, 0));
      cusp::array1d<cusp::complex<double>, devMem>
	solution(nCols, cusp::complex<double>(0, 0));

      // And another load as we'll need duplicates for the
      // multiplication routines
      cusp::array1d<cusp::complex<double>, devMem>
	tempSource(nCols, cusp::complex<double>(0, 0));
      cusp::array1d<cusp::complex<double>, devMem>
	tempSolution(nCols, cusp::complex<double>(0, 0));

      // Create a temporary propagator variable for fast access
      cusp::array2d<cusp::complex<double>, devMem>
	tempPropagator(nCols, 12, cusp::complex<double>(0, 0));

      // Create the preconditioner
      cusp::precond::diagonal<cusp::complex<double>, devMem>
	...
	for (int j = 0; j < 3; ++j) {
	  ...
	  cusp::default_monitor<cusp::complex<double> >
	  ...
	  cusp::array2d<cusp::complex<double>, devMem>::column_view
