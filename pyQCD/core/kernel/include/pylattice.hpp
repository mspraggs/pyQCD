...
public:
  ...
  py::list computeNaikPropagatorP(const double mass, const py::list site,
				  ...
				  const double tolerance,
				  const int verbosity);
  py::tuple invertWilsonDiracOperatorP(const py::list eta, const double mass,
				       const py::list boundaryConditions,
				       const int solverMethod,
				       const int precondition,
				       const int maxIterations,
				       const double tolerance,
				       const int verbosity);
  py::tuple invertHamberWuDiracOperatorP(const py::list eta, const double mass,
					 const py::list boundaryConditions,
					 const int solverMethod,
					 const int precondition,
					 const int maxIterations,
					 const double tolerance,
					 const int verbosity);
  py::tuple invertNaikDiracOperatorP(const py::list eta, const double mass,
				     const py::list boundaryConditions,
				     const int solverMethod,
				     const int precondition,
				     const int maxIterations,
				     const double tolerance,
				     const int verbosity);
  py::tuple invertDWFDiracOperatorP(const py::list eta, const double mass,
