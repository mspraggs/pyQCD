...
{  
  ...
  int n = this->T * this->L * this->L * this->L * 12;
  ...
  for (int i = 0; i < this->Ls_; ++i) {
    ...
    if (i == 0) {
      applyPminus<<<dimGrid,dimBlock>>>(z, x + n, this->L, this->T);
      saxpyDev<<<dimGrid,dimBlock>>>(y + i * n, z, -1.0, n);
      applyPplus<<<dimGrid,dimBlock>>>(z, x + n * (this->Ls_ - 1), this->L, this->T);
      saxpyDev<<<dimGrid,dimBlock>>>(y + i * n, z, this->mass_, n);
    }
    else if (i == this->Ls_ - 1) {
      applyPplus<<<dimGrid,dimBlock>>>(z, x + n * (this->Ls_ - 2), this->L, this->T);
      saxpyDev<<<dimGrid,dimBlock>>>(y + i * n, z, -1.0, n);
      applyPminus<<<dimGrid,dimBlock>>>(z, x, this->L, this->T);
      saxpyDev<<<dimGrid,dimBlock>>>(y + i * n, z, this->mass_, n);
    }
    else {
      applyPminus<<<dimGrid,dimBlock>>>(z, x + (i + 1) * n, this->L, this->T);
      saxpyDev<<<dimGrid,dimBlock>>>(y + i * n, z, -1.0, n);
      applyPplus<<<dimGrid,dimBlock>>>(z, x + (i - 1) * n, this->L, this->T);
      saxpyDev<<<dimGrid,dimBlock>>>(y + i * n, z, -1.0, n);
    }
  }
...
void DWF::makeHermitian(Complex* y, const Complex* x) const
{
  ...
  for (int i = 0; i < this->Ls_; ++i) {
    ...
    applyGamma5<<<dimGrid, dimBlock>>>(z, xi, this->L, this->T);
    this->kernel_->apply(y_ptr, z);
    saxpyDev<<<dimGrid,dimBlock>>>(y_ptr, z, 1.0, n);
    applyGamma5<<<dimGrid,dimBlock>>>(y_ptr, y_ptr, this->L, this->T);    

    if (i == 0) {
      assignDev<<<dimGrid, dimBlock>>>(x0, xi, n);

      applyPplus<<<dimGrid,dimBlock>>>(z, x + n, this->L, this->T);
      saxpyDev<<<dimGrid,dimBlock>>>(y_ptr, z, -1.0, n);
      ...
      applyPminus<<<dimGrid,dimBlock>>>(z, xim1, this->L, this->T);
      saxpyDev<<<dimGrid,dimBlock>>>(y_ptr, z, -1.0, n);
      applyPplus<<<dimGrid,dimBlock>>>(z, x0, this->L, this->T);
      saxpyDev<<<dimGrid,dimBlock>>>(y_ptr, z, this->mass_, n);
    }
    else {
      applyPplus<<<dimGrid,dimBlock>>>(z, x_ptr + n, this->L, this->T);
      saxpyDev<<<dimGrid,dimBlock>>>(y_ptr, z, -1.0, n);
      applyPminus<<<dimGrid,dimBlock>>>(z, xim1, this->L, this->T);
      saxpyDev<<<dimGrid,dimBlock>>>(y_ptr, z, -1.0, n);
    }
